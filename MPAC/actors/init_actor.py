...
from MPAC.actors.continuous_actors import GaussianActor
from MPAC.actors.continuous_actors import GaussianActorwAdversary
...
def init_actor(env,actor_layers,actor_activations,actor_init_type,actor_gain,
    ...
    if isinstance(env.action_space,gym.spaces.Box):
        if (actor_adversary_prob > 0.0):
            ...
            # Action-robust PR-MDP approach for baseline 
