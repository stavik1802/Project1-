...
parser.add_argument('--runs',help='number of trials',type=int,default=3)
...
rwrl_kwargs = [
    ...
    'multiobj_coeff','multiobj_enable',

    'energy_constraints', 'energy_constraints_all',
]
...
# Added energy constraints
parser.add_argument('--energy_constraints',nargs='+',
    help='energy active constraint names',type=str)
parser.add_argument('--energy_constraints_all',help='use all energy constraints',
    action='store_true')
...
parser.add_argument('--multiobj_coeff', type=float, default=0.0,
                        help='A number in [0,1] used as a reward mixing ratio by the Objective object')
parser.add_argument('--multiobj_enable', action='store_true', default=False,
                        help='Whether to enable multi-objective challenge')
...
critic_kwargs = [
    ...
    'critic_layer_norm', 'use_cagrad', 'use_dynamic_weights'
]
...
parser.add_argument('--no_cagrad',
    help='disable CAGrad optimization',
    dest='use_cagrad', default=True, action='store_false')
parser.add_argument('--no_dynamic_weights',
    help='disable dynamic influence-based weights',
    dest='use_dynamic_weights', default=True, action='store_false')
...
parser.add_argument('--gamma',help='discount rate',type=float,default=1.00)
...
parser.add_argument('--total_timesteps',
    help='total number of real timesteps for training',type=float,default=500000)

parser.add_argument('--env_horizon',
    help='rollout horizon for real trajectories',type=int,default=48)
